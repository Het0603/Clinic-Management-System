  ...
  return (
    <>
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-xl font-semibold">Dr. Matt Brew Mburuge</h1>
      </div>
      <div className=" grid grid-cols-12 gap-6 my-8 items-start">
        ...
        >
          ...
          <div className="gap-3 flex-colo">
            <h2 className="text-sm font-semibold">Dr. Matt Brew Mburuge</h2>
            <p className="text-xs text-textGray">Matt Brewmburuge@gmail.com</p>
